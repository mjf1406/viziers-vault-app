        ...
        <div className="space-y-6 p-4 xl:p-10 min-h-dvh">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Skeleton className="hidden sm:inline-flex h-10 w-[200px] rounded-md" />
                    ...
                    >
                        <CardHeader className="relative w-full mx-auto">
                            <div className="flex items-start gap-4">
                                ...
                                {/* Action buttons skeleton (3 buttons for magic shops) */}
                        ...
                        <CardContent>
                            <div className="space-y-2">
                                {/* Population, wealth, and magic level badges */}
