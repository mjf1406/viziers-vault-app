...
The Magic Shop Generator creates inventories for magical shops in your D&D 5e campaigns. It considers multiple factors to determine what items appear in a shop and at what prices.
## Core Principles
...
-   **Poor settlements**: Items are more expensive (up to 50% discount by default)
-   **Rich settlements**: Items are cheaper (up to 50% markup by default)
...
Each rarity has a base price depending on item tier within the rarity.
### Price Modifiers
...
**The following settings are for premium users only.**
### Slot Beta
...
5. **Consider Wealth**: Rich settlements are cheaper, poor settlements are expensive